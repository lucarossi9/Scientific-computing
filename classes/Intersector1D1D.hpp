...
namespace GeDiM
{
    ...
    class Intersector1D1D
    {
        public:
            ...
            {
                NoIntersection = 0,
                IntersectionOnLine = 1, //sulla retta ma non dentro al segmento
                IntersectionOnSegment = 2, // all'interno del segmento
                IntersectionParallelOnLine = 3,  // le rette si sovrappongono ma i segmenti no
                IntersectionParallelOnSegment = 4 // i due segmenti si sovrappongono
            };
            enum Position
            {
                Begin = 0,
