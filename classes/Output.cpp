...
namespace MainApplication
{
	...
	void Output::Initialize(const unsigned int& rank, const unsigned int& numProcesses)
	{
		...
		//UnitTest_Summary::Initialize(rank, numProcesses);
	...
	// ***************************************************************************
	const Output::ExitCodes Output::GetBinaryFileSize(const string& nameFile, unsigned int& fileSize, const unsigned int& sizeOfSingleDataToWrite, const unsigned int& startingPosition)
	{
		/// <ul>
	...
	// ***************************************************************************
	const Output::ExitCodes Output::ReadBinaryFile(const string& nameFile, void* dataToRead, const unsigned int& sizeOfSingleDataToWrite, const unsigned int& dataSizeToRead, const unsigned int& startingPosition)
	{
		/// <ul>
	...
	// ***************************************************************************
	const Output::ExitCodes Output::WriteBinaryFile(const string& nameFile, const void* dataToWrite, const unsigned int& sizeOfSingleDataToWrite, const unsigned int& dataSizeToWrite, const bool& append)
	{
		/// <ul>
	...
	void Output::Assert(const bool& logicResult, const string& message, ...)
	{
		...
		UnitTest_Summary::CheckUnitTest(logicResult);
	...
	// ***************************************************************************
	unsigned int UnitTest_Summary::Rank = 0;
	unsigned int UnitTest_Summary::NumberProcesses = 1;
	unsigned int UnitTest_Summary::numberTotalTests = 0;
	unsigned int UnitTest_Summary::numberSuccessTests = 0;
	unsigned int UnitTest_Summary::numberErrorTests = 0;
	// ***************************************************************************
	void UnitTest_Summary::CheckUnitTest(const bool& logicResult)
	{
		numberTotalTests++;
	...
	// ***************************************************************************
	void UnitTest_Summary::CheckUnitTest(const Output::ExitCodes& logicResult)
	{
		if (Rank > 0)
			return;
	...
	// ***************************************************************************
	void UnitTest_Summary::PrintSummary()
	{
		if (Rank > 0)
			return;
	...
	void Profiler::StopTime(const string& nameTime, const bool& printTime)
	{
		...
		if(Rank == 0)
		{
			...
			nameFile<< nameFolder.str()<< ConfigFile::Log().TimeFile()<< ".csv";
		...
		nameFile<< nameFolder.str()<< ConfigFile::Log().TimeFile()<< "_"<< Rank<< ".csv";
		bool fileExists = Output::FileExists(nameFile.str());
